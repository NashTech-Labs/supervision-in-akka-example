...
import org.knoldus.supervision.SupervisionApplication.Cache.{Find, Hit}
import org.knoldus.supervision.SupervisionApplication.Main.{Created, Start}
import org.scalatest.matchers.should.Matchers.convertToAnyShouldWrapper
import org.knoldus.supervision.SupervisionApplication.{Cache, File, Filesystem, WebServer}
import org.knoldus.supervision.SupervisionApplication.WebServer.{BadRequest, Get, Ok, Response}
import org.scalatest.{BeforeAndAfterAll, FlatSpec}
import scala.concurrent.duration.DurationInt

class SupervisionApplicationSpec  extends FlatSpec with BeforeAndAfterAll {
